<?php
/**
 * A model for managing Lumina modules.
 * 
 * @package LuminaCore
 */
class CMModules extends CObject {
   ...
   * Properties
   */
  private $luminaCoreModules = array('CLumina', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $luminaCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier', 'CTextFilter');
  ...
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isLuminaCore']   = in_array($rc->name, $this->luminaCoreModules);
      $details['isLuminaCMF']    = in_array($rc->name, $this->luminaCMFModules);

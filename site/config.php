 ...
 * Define menus.
 *
 * Create hardcoded menus and map them to a theme region through $lu->config['theme'].
 */
 ...
 * Template files can reside in the parent or current theme, the CLumina::ThemeEngineRender()
 ...
 *
 * path: Path to current theme, relativly LUMINA_INSTALL_PATH, for example themes/grid or site/themes/mytheme.
